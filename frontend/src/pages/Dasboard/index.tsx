...
const Dashboard: React.FC = () => {
  ...
  const [currentMonth, steCurrentMonth] = useState(new Date());
  ...
  const disabledDays = useMemo(() => {
    const dates = monthAvailable.filter(monthDay => monthDay.available === false).map(monthDay => {
